...
class Ui_Ftp(object):
    def setupUi(self, MainWindow):
        ...
        self.passwordFTP.setEchoMode(QtGui.QLineEdit.Password)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_6.setText(_translate("MainWindow", "Remote Folder:", None))
        self.ftpCancelButton.setText(_translate("MainWindow", "Cancel", None))
        self.ftpOkButton.setText(_translate("MainWindow", "Ok", None))
        self.label_7.setText(_translate("MainWindow", "Project Details", None))
