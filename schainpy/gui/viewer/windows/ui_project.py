...
class Ui_ProjectTab(object):
    ...
    def setupUi(self):
        ...
        self.proComReadMode.addItem(_fromUtf8(""))
        self.gridLayout_2.addWidget(self.proComReadMode, 3, 1, 1, 4)
        ...
        self.gridLayout_2.addWidget(self.labelSet, 3, 7, 1, 1)
        self.proSet = QtGui.QLineEdit(self.frame)
        self.proSet.setObjectName(_fromUtf8("proSet"))
        self.gridLayout_2.addWidget(self.proSet, 3, 8, 1, 1)
        self.labelIPPKm = QtGui.QLabel(self.frame)
        self.labelIPPKm.setObjectName(_fromUtf8("labelIPPKm"))
        self.gridLayout_2.addWidget(self.labelIPPKm, 3, 7, 1, 1)
        self.proIPPKm = QtGui.QLineEdit(self.frame)
        self.proIPPKm.setObjectName(_fromUtf8("proIPPKm"))
        self.gridLayout_2.addWidget(self.proIPPKm, 3, 8, 1, 1)
    ...
    def retranslateUi(self):
        ...
        self.labelSet.setText(_translate("MainWindow", "Set:", None))
