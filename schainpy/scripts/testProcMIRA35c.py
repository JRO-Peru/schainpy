...
opObj22.addParameter(name='colormap', value='jet', format='str')
# opObj22.addParameter(name='figpath', value = '/home/erick/Pictures', format='str')
opObj22.addParameter(name='zmin', value='-70', format='int')
opObj22.addParameter(name='zmax', value='0', format='int')  
