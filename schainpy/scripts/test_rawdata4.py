...
procUnitConfObjSousySpectra.addParameter(name='nFFTPoints', value='32', format='int')
procUnitConfObjSousySpectra.addParameter(name='nProfiles', value='32', format='int')
...
#opObj11.addParameter(name='xmin', value=-0.5, format='float')
#opObj11.addParameter(name='xmax', value=0.5, format='float')
