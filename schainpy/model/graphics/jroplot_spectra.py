...
class SpectraPlot(Figure):
    ...
    def run(self, dataOut, id, wintitle="", channelList=None, showprofile=True,
        ...
        #zdB2=z.copy()
        #zdB2 = numpy.where(numpy.isfinite(zdB2), zdB2, numpy.NAN)
        #zdB2=numpy.transpose(zdB2, (0,2,1))
        #av=numpy.ones(136)
        #for i in range(136):
            
        #    lenFFT = zdB2[0][i][~numpy.isnan(zdB2[0][i])]    
            #print len(lenFFT)
        #    av[i] = numpy.average(lenFFT) 

        
        #print 'SPC dBs', av.shape
        #print 'SPC dBs', 10*numpy.log10(av)

        avg = numpy.average(z, axis=1)
        avgdB = 10*numpy.log10(avg)
        #print 'avgdB', avgdB.shape
        #print 'avgdB', avgdB
