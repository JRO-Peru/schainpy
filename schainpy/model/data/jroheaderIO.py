...
BASIC_STRUCTURE = numpy.dtype([          #BASIC HEADER 24bytes
                          ('nSize','<u4'),
                          ('nVersion','<u2'),
                          ('nDataBlockId','<u4'),
                          ('nUtime','<u4'),     #  \ 
                          ('nMilsec','<u2'),    #   }  time Structure 10bytes
                          ('nTimezone','<i2'),  #  /
                          ('nDstflag','<i2'),   # /
                          ('nErrorCount','<u4')
                          ])

SYSTEM_STRUCTURE = numpy.dtype([         #LONG HEADER 24bytes
                            ('nSize','<u4'),
                            ('nNumSamples','<u4'),
                            ('nNumProfiles','<u4'),
                            ('nNumChannels','<u4'),
...
RADAR_STRUCTURE = numpy.dtype([         #RADAR CONTROLLER PARAMETERS  116bytes  
                             ('nSize','<u4'),
                             ('nExpType','<u4'),
                             ('nNTx','<u4'),
                             ('fIpp','<f4'),
                             ...
                             ('nPrePulseBefore','<u4'),
                             ('nPrePulseAfter','<u4'),
                             ('sRangeIPP','<a20'),   #Includes: sRange_TR 16bytes & nDinFlags 4bytes
                             ('sRangeTxA','<a20'),
                             ('sRangeTxB','<a20'),
                             ])

SAMPLING_STRUCTURE = numpy.dtype([('h0','<f4'),
                                  ('dh','<f4'),
                                  ('nsa','<u4')])


PROCESSING_STRUCTURE = numpy.dtype([        #PROCESS PARAMETERS 40bytes
                               ('nSize','<u4'),
                               ('nDataType','<u4'),
                               ('nSizeOfDataBlock','<u4'),
